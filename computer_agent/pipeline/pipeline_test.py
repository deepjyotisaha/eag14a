...
import asyncio
from utils.gemini_integration_test import run_gemini_analysis, integrate_gemini_results
...
async def run_pipeline_test(image_path, mode="debug", output_dir=None):
    """
